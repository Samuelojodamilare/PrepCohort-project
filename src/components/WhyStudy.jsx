      ...
      <div className={`${layout.container}`}>
        ...
        <div
          ...
          <div className="absolute inset-0 ">
            <svg
              className="hidden md:block absolute top-1/2 -right-[7%] transform -translate-y-1/2 w-full h-aut0 max-w-[620px] "
              viewBox="0 0 612 563"
              fill="none"
            ...
            <div className="absolute top-1/2 -right-[3%] transform -translate-y-1/2 z-10 w-[450px] h-[450px] rounded-full overflow-hidden">
              <img
                src={whyStudyImg}
                alt="desktop"
