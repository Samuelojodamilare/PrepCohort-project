...
const PracticeQuestionCard = ({ label, id, description }) => {
  return (
    <a
      ...
      <div
        className="flex flex-col items-center font-workSans space-y-2 rounded-xl max-0.5xl:mb-20 my-10 mr-[30px] transition transform hover:-translate-y-2 ease-in-out duration-500"
        style={{
